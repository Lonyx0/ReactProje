...
const FactV1 = () => {
    return (
        <>
            <div id="yetenek" className="fun-factor-area default-padding overflow-hidden">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-8 offset-lg-2">
                            <div className="site-heading text-center">
                                <h4 className="sub-title">Yeteneklerim</h4>
                                <h2 className="title">Uzmanlıklarımı Görün</h2>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="fun-fact-style-two-items text-center">
                        ...
                        <ReactWOW animation="fadeInUp" delay="500ms">
                            <div className="funfact-style-two-item">
                                ...
                                <div className="fun-fact">
                                    <div className="counter">
                                        <div className="timer"><CountUp end={40} enableScrollSpy={true} /></div>
                                        <div className="operator">%</div>
                                    </div>
